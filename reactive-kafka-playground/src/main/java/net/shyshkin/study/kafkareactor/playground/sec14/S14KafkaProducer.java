...
public class S14KafkaProducer {

    private static final Logger log = LoggerFactory.getLogger(S14KafkaProducer.class);
    ...
    public static void main(String[] args) {
        ...
        var producerProperties = Map.<String, Object>of(
                ...
                VALUE_SERIALIZER_CLASS_CONFIG, IntegerSerializer.class
        );

        var senderOptions = SenderOptions.<String, Integer>create(producerProperties);

        var eventFlux = Flux.range(1,100)
